//this page fully work on for Below30Ha offline list Screen
// ignore_for_file: must_be_immutable, camel_case_types, unused_field, prefer_typing_uninitialized_variables, unused_local_variable, body_might_complete_normally_nullable
...
import '30Ha_Screen.dart';

class Offline_List30Ha extends StatefulWidget {
  int? omsId;
  int? amsId;
  int? getwayId;
  int? rmsId;
  ...
  @override
  State<Offline_List30Ha> createState() => _Offline_List30HaState();
}

class _Offline_List30HaState extends State<Offline_List30Ha> {
  @override
  void initState() {
    fatchdataSQL();
    // datashort();
...
//first load list below 30ha from offline database anduse it
                ...
                onTap: () async {
                  ...
                  final temp = await Navigator.of(context).push(
                    MaterialPageRoute(
                        ...
                        builder: (context) => Node_30HaScreen(
