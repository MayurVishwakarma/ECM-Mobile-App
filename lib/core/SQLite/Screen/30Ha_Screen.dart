// //node details and opation information  for 30Ha Screen
// // ignore_for_file: must_be_immutable, camel_case_types, unused_field, non_constant_identifier_names, unused_local_variable, unnecessary_null_comparison, unused_catch_stack, prefer_collection_literals, prefer_const_constructors, prefer_const_literals_to_create_immutables, unused_element, use_build_context_synchronously
...
// import '../../../Screens/Home/ECM_Tool-Screen/NodeDetails_30Ha.dart';
...
// class Node_30HaScreen extends StatefulWidget {
//   int? omsId;
//   int? amsId;
//   int? getwayId;
//   int? rmsId;
...
//       this.deviceId});
//   @override
//   State<Node_30HaScreen> createState() => _Node_30HaScreenState();
// }

// class _Node_30HaScreenState extends State<Node_30HaScreen> {
...
// //off data upload to server  using offline Screen
...
//           );
//           ScaffoldMessenger.of(context).showSnackBar(snackBar);
//           //drop table both process and datalist
...
//       var omsId = imageList.first.deviceId;
//       String submitDate =
...
//       Insertobj["ApprovedStatus"] = imageList.first.approvedStatus;
...
//                                             return AlertDialog(
//                                               title: Text(
//                                                   "Please Connect Main Page"),
//                                               content: Text(
//                                                   "Sorry, PDF is Not Load."),
//                                               actions: [
//                                                 TextButton(
//                                                   child: Text("OK"),
//                                                   onPressed: () =>
