// //node details and opation information  for all Sql project Screen
// // ignore_for_file: must_be_immutable, camel_case_types, non_constant_identifier_names, use_key_in_widget_constructors, unused_element, unused_catch_stack, unused_field, prefer_is_empty, unused_local_variable, unnecessary_null_comparison, prefer_typing_uninitialized_variables, no_leading_underscores_for_local_identifiers, prefer_const_constructors, use_build_context_synchronously, prefer_const_literals_to_create_immutables
...
// import '../../../Screens/Home/ECM_Tool-Screen/NodeDetails_SQL.dart';
...
// class SQL_Screen extends StatefulWidget {
//   int? omsId;
//   int? amsId;
//   int? getwayId;
//   int? rmsId;
...
//       this.deviceId});
//   @override
//   State<SQL_Screen> createState() => _SQL_ScreenState();
// }

// class _SQL_ScreenState extends State<SQL_Screen> {
...
//                       color: Color.fromARGB(255, 73, 162, 225),
//                       borderRadius: BorderRadius.circular(5.0)),
...
//           );
//           ScaffoldMessenger.of(context).showSnackBar(snackBar);
//           await DBSQL.instance.deleteChecklist(datas.first);
//           await DeviceAllDAta();
//           if (nodedata.isEmpty) {
...
//       datas = await DBSQL.instance.fetchData();
//       return result;
