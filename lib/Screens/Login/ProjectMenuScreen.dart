          ...
          child: SingleChildScrollView(
            ...
            child: SizedBox(
              ...
              child: Column(
                ...
                children: [
                  if (ip.connectionStatus == 'checking')
                    Center(child: CircularProgressIndicator()),
                  if (ip.connectionStatus == 'connected')
                    Padding(
                  ...
                  if (ip.connectionStatus == 'disconnected')
                    Center(
  ...
  getUserId() async {
    try {
      ...
      final res = await http.get(Uri.parse(
          'http://ecmv2.iotwater.in:3011/api/v1/project/users/$mobileNo/0/$projectId'));
