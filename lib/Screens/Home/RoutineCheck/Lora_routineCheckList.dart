  ...
  Future<void> fetchRoutineTime() async {
    ...
    if (response.statusCode == 200) {
      ...
      if (routineTimeModel.data != null &&
        ...
        final days = routineTimeModel.data!.response.first.days;
        setState(() {
