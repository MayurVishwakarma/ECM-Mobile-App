...
class SelectedAmsDamageMatrialScreen extends StatefulWidget {
  SelectedAmsDamageMatrialScreen(
      {Key? key,
      AreaModel? area_,
  ...
  @override
  State<SelectedAmsDamageMatrialScreen> createState() =>
      _SelectedAmsDamageMatrialScreenState();
}

class _SelectedAmsDamageMatrialScreenState
    extends State<SelectedAmsDamageMatrialScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('List By Selected Material'),
      ),
  ...
  void _firstLoad() async {
    ...
    try {
      ...
      // http://wmsservices.seprojects.in/api/Rectify/RectifyReportStatus_DateFilter?Search=&areaId=all&DistributoryId=all&source=oms&isFilter=59,57&conString=Data Source=65.21.7.97;Initial Catalog=BansujaraGL;User ID=sa;Password=sapl@1234
