...
class SelectedOmsDamageMatrialScreen extends StatefulWidget {
  ...
  @override
  State<SelectedOmsDamageMatrialScreen> createState() =>
      _SelectedOmsDamageMatrialScreenState();
}

class _SelectedOmsDamageMatrialScreenState
    extends State<SelectedOmsDamageMatrialScreen> {
                  ...
                  children: [
                    ...
                    SizedBox(
                        ...
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Text(getDeviceNameValue(Source!, index),
                                style: TextStyle(
                                    fontSize: 12,
                                    fontWeight: FontWeight.bold,
                                    color: Colors.black)),
