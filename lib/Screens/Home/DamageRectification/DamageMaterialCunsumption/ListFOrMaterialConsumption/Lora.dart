...
class Lora_MaterialConsumption extends StatefulWidget {
  String? ProjectName;
  String? Source;
  Lora_MaterialConsumption({this.ProjectName, this.Source});
  @override
  State<Lora_MaterialConsumption> createState() =>
      _Lora_MaterialConsumptionState();
}

class _Lora_MaterialConsumptionState extends State<Lora_MaterialConsumption> {
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                //tubing
                                if ((_DisplayList!.first.tubing ?? 0) != 0)
                                  Padding(
                                    padding: const EdgeInsets.all(5.0),
                                    child: InkWell(
                                      onTap: () {
                                ...
                                ///Mechanical
                                if ((_DisplayList!.first.mechanical ?? 0) != 0)
                                  Padding(
                                    padding: const EdgeInsets.all(5.0),
                                    child: InkWell(
                                      onTap:
                          ...
                          if ((selectedDamageType!
                                  ...
                                  selectedDamageType!
                                      .toLowerCase()
                                      .contains('mechanical')) &&
                              (_DisplayList!.first.mechanical ?? 0) != 0)
                            ExpansionTile(
                              title: Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Container(
