...
class Oms_MaterialConsumption extends StatefulWidget {
  String? ProjectName;
  String? Source;
  Oms_MaterialConsumption({this.ProjectName, this.Source});
  @override
  State<Oms_MaterialConsumption> createState() =>
      _Oms_MaterialConsumptionState();
}

class _Oms_MaterialConsumptionState extends State<Oms_MaterialConsumption> {
                    ...
                    Column(
                      children: [
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    "TOTAL OMS : " +
                                        (_DisplayList!.first.totalDevice ?? 0)
                                            .toString(),
                                    style: TextStyle(
                                        color: Colors.white,
                                        fontWeight: FontWeight.bold,
                        ...
                        if (selectedDamageType!
                                .toLowerCase()
                                .contains('total') ||
                            selectedDamageType!.contains('Tubing'))
                          ExpansionTile(
                            title: Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: Container(
  ...
  void _firstLoad() async {
    ...
    try {
      ...
      final res = await http.get(Uri.parse(
          'http://ecmtest.iotwater.in:3011/api/v1/damage/materialConsumptionSummaryCount/$projectId/$area/$distibutory/OMS'));
