                                                          ...
                                                          Text(
                                                            ...
                                                            style: TextStyle(
                                                                ...
                                                                fontWeight:
                                                                    FontWeight
                                                                        .bold,
                                                                color: getLenth(_DisplayList![index].electRectifyList ??
                                                                            "") !=
                                                                        0
                                                                    ? Colors.red
                                                                    : Colors
                                                            ...
                                                            Text(
                                                              ...
                                                              style: TextStyle(
                                                                  ...
                                                                  fontWeight:
                                                                      FontWeight
                                                                          .bold,
                                                                  color: getLenth(_DisplayList![index].tubRectifyList ??
                                                                              "") !=
                                                                          0
                                                                      ? Colors
                                                                          .red
                                                            ...
                                                            Text(
                                                              ...
                                                              style: TextStyle(
                                                                  ...
                                                                  fontWeight:
                                                                      FontWeight
                                                                          .bold,
                                                                  color: getLenth(_DisplayList![index].mechRectifyList ??
                                                                              "") !=
                                                                          0
                                                                      ? Colors
                                                                          .red
    ...
    try {
      if (widget.Source!.toLowerCase() == 'oms') {
        ...
        getMaterialConsumptionHistory(
                (modelData!.gatewayId ?? 0), widget.Source!)
            .then((value) {
          setState(() {
            remarkval = value.first.remark ?? "";
            workedondate = (value.first.reportedOn ?? '').toString();
