...
class Lora_History extends StatefulWidget {
  @override
  State<Lora_History> createState() => _Lora_HistoryState();
}

class _Lora_HistoryState extends State<Lora_History> {
                      ...
                      SizedBox(
                          ...
                          child: Center(
                            child: Container(
                              ...
                              height: 30,
                              decoration: BoxDecoration(
                                  color: (_DisplayList![index].electrical ??
                                              0) !=
                                          0
                                      ? Colors.red
