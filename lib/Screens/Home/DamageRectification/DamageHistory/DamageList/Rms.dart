...
class Rms_History extends StatefulWidget {
  String? ProjectName;
  String? Source;
  Rms_History({this.ProjectName, this.Source});

  @override
  State<Rms_History> createState() => _Rms_HistoryState();
}

class _Rms_HistoryState extends State<Rms_History> {
                      ...
                      SizedBox(
                          ...
                          child: Center(
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  color:
                                      (_DisplayList![index].electrical ?? 0) !=
                                              0
                                          ? Colors.red
                                          : Colors.green,
                      ...
                      SizedBox(
                          ...
                          child: Center(
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  color:
                                      (_DisplayList![index].mechanical ?? 0) !=
                                              0
                                          ? Colors.red
                                          : Colors.green,
                                  borderRadius: BorderRadius.circular(20)),
