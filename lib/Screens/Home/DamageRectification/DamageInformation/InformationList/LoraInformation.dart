...
class Lora_information extends StatefulWidget {
  String? ProjectName;
  String? Source;
  Lora_information({this.ProjectName, this.Source});
  @override
  State<Lora_information> createState() => _Lora_informationState();
}

class _Lora_informationState extends State<Lora_information> {
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: GridView.builder(
                              ...
                              shrinkWrap: true,
                              itemCount: _DisplayList!
                                  .length, //_electricalList!.length,
                              gridDelegate:
  ...
  void _firstLoad() async {
    ...
    try {
      ...
      final res = await http.get(Uri.parse(
          'http://ecmtest.iotwater.in:3011/api/v1/damage/informationSummaryCount/$projectId/$area/$distibutory/LORA/info'));
