...
class Oms_information extends StatefulWidget {
  String? ProjectName;
  String? Source;
  Oms_information({this.ProjectName, this.Source});
  @override
  State<Oms_information> createState() => _Oms_informationState();
}

class _Oms_informationState extends State<Oms_information> {
  ...
  void _firstLoad() async {
    ...
    try {
      ...
      final res = await http.get(Uri.parse(
          'http://ecmtest.iotwater.in:3011/api/v1/damage/informationSummaryCount/$projectId/$area/$distibutory/OMS/info'));
