...
import 'package:ecm_application/Screens/Home/DamageRectification/DamageIssues/SelectedIssues/SelectedOmsDamageIssuesList.dart';
...
class Oms_Issues extends StatefulWidget {
  String? ProjectName;
  String? Source;
  Oms_Issues({this.ProjectName, this.Source});
  @override
  State<Oms_Issues> createState() => _Oms_IssuesState();
}

class _Oms_IssuesState extends State<Oms_Issues> {
        ...
        child: SingleChildScrollView(
            ...
            child: Column(
                ...
                children: [
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            onTap: () {
                              ...
                              selectedDamageType = "Total Issues Detected";
                              _firstLoad();
                            },
                            onDoubleTap: () {
                              setState(() {
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      "Total Issues Detected".toUpperCase(),
                                      textAlign: TextAlign.center,
                                      style: TextStyle(
                                        color: Colors.black,
                                        fontSize: 9,
                  ...
                  if (_DisplayList!.isEmpty && _isloading == false)
                    Center(
                      child: Container(
  ...
  void _firstLoad() async {
    ...
    try {
      ...
      final res = await http.get(Uri.parse(
          'http://ecmtest.iotwater.in:3011/api/v1/damage/informationSummaryCount/$projectId/$area/$distibutory/OMS/issue'));
