...
class Lora_issues extends StatefulWidget {
  String? ProjectName;
  String? Source;
  Lora_issues({this.ProjectName, this.Source});
  @override
  State<Lora_issues> createState() => _Lora_issuesState();
}

class _Lora_issuesState extends State<Lora_issues> {
