...
import 'package:ecm_application/Screens/Home/DamageRectification/DamageReportStatus/SelectDamageListForLora.dart'
    hide ListCommonScreen;
...
class Lora_ReportList extends StatefulWidget {
  String? ProjectName;
  String? Source;
  Lora_ReportList({this.ProjectName, this.Source});
  @override
  State<Lora_ReportList> createState() => _Lora_ReportListState();
}

class _Lora_ReportListState extends State<Lora_ReportList> {
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                "TOTAL GATEWAY : ${_DisplayList!.first.cNT!}",
                                style: TextStyle(
                                    color: Colors.white,
