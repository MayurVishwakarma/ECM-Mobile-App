...
class Rms_ReportList extends StatefulWidget {
  String? ProjectName;
  String? Source;
  Rms_ReportList({this.ProjectName, this.Source});
  @override
  State<Rms_ReportList> createState() => _Rms_ReportListState();
}

class _Rms_ReportListState extends State<Rms_ReportList> {
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(
                                      "TOTAL RMS : ${_DisplayList!.first.totalRMS!}",
                                      style: TextStyle(
                                          color: Colors.white,
  ...
  void _firstLoad() async {
    ...
    try {
      ...
      final res = await http.get(Uri.parse(
          'http://ecmtest.iotwater.in:3011/api/v1/damage/damageSummaryCount/$projectId/RMS/$area/$distibutory'));
