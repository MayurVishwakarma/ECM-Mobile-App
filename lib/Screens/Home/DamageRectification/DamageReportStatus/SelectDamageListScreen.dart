...
class _ListCommonScreenState extends State<ListCommonScreen> {
                  ...
                  ? Column(
                      ...
                      children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                                "Total Node Loaded: ${_DisplayList?.length}"),
                          ),
                          Padding(
                  ...
                  children: [
                    ...
                    SizedBox(
                        ...
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Text(getNodeName(Source, _DisplayList![index])!,
                                style: TextStyle(
                                    fontSize: 12,
                                    fontWeight: FontWeight.bold,
                                    color: Colors.black)),
  ...
  String? getNodeName(String? source, DamageReportCountCommon data) {
    try {
      var result;
      switch (source) {
        case 'OMS':
