...
//fatch specific data
  ...
  Future getImage(ImageSource media, int index) async {
    ...
    storeImagesInSharedPref(
        watermarkedFile.path, imageList![index].checkListId.toString());
            ...
            Expanded(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  suffixText:
                      (item.inputText != null && item.inputText!.isNotEmpty)
                          ? item.inputText!
                          : '',
                ),
                onChanged: (value) async {
                  if (item.description!.toLowerCase().contains('width') ||
                      item.description!.toLowerCase().contains('depth') ||
                      item.description!.toLowerCase().contains('length')) {
                    fetchTotalValue();
                    setState(() {
              ...
              child: Row(
                children: [
                  IconButton(
                    onPressed: () {
                      GetPDFbyPath(getAppbarName('below30ha'));
                      base64ToPdf(pdfString!, getAppbarName('below30ha'));
                    },
